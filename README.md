# MadoRunes Offline (魔女文字典、转换器与离线百科)
...
<p align="center">
  一个基于 Jetpack Compose 开发的纯离线《魔法少女小圆》魔女文（Madoka Runes）对照字典、实时转换与离线维基查询工具。
</p>
...
- **四大字体**：收录古代体（大写）、现代体（小写）、音乐体、哥特体，支持多字体就地离线渲染。
- **实时转换**：输入英文或数字即可动态生成魔女文，支持一键导出为图形文件。
- **离线维基**：内置完全本地化的百科条目。随着应用版本的维护与更新，离线词条将逐步完善，涵盖魔圆系列的核心考据、魔女档案与常用词条。
- **双主题切换**：
  - **浅色模式（鹿目圆）**：采用粉色与白色为主体色调。
  - **深色模式（晓美焰）**：采用紫黑色与银灰色为主体色调。
- **多语言支持**：用户界面支持简体中文、English、日本語。
